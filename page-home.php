...
<section class="home-funnel">
    ...
    <!--Restaurant Button-->
    <div class="funnel-button">
        <p class="funnel-icon">
            <a href="<?= bloginfo('url'); ?>/construction-type/restaurant">
                <img src="<?php bloginfo('template_url') ?>/img/icons/spoon-knife.svg" alt="Restaurant Icon" title="Restaurant Icon"></br>Restaurant
            </a>
        </p>
    </div>
    ...
    <div class="funnel-button">
        <p class="funnel-icon">
            <a href="<?= bloginfo('url'); ?>/construction-type/office">
                <img src="<?php bloginfo('template_url') ?>/img/icons/aid-kit.svg" alt="Office Icon" title="Office Icon"><br/>Office
            </a>
        </p>
    </div>
    ...
    <div class="funnel-button">
        <p class="funnel-icon">
            <a href="<?= bloginfo('url'); ?>/construction-type/industrial">
                <img src="<?php bloginfo('template_url') ?>/img/icons/gears.svg" alt="Industrial Icon" title="Industrial Icon">
                <br/>Industrial
            </a>
        </p>
    </div>
    ...
    <div class="funnel-button">
        <p class="funnel-icon">
            <a href="<?= bloginfo('url'); ?>/construction-type/mixed">
                <img src="<?php bloginfo('template_url') ?>/img/icons/office.svg" alt="Mixed Use Development Icon" title="Mixed Use Development Icon"></br>Mixed Use
            </a>
        </p>
    </div>
    ...
    <div class="funnel-button">
        <p class="funnel-icon">
            <a href="<?= bloginfo('url'); ?>/construction-type/interior">
                <img src="<?php bloginfo('template_url') ?>/img/icons/hammer.svg" alt="Renovation Icon" title="Renovation Icon"><br/>Interior Renovation
            </a>
        </p>
    </div>
    ...
    <div class="funnel-button">
        <p class="funnel-icon">
            <a href="<?= bloginfo('url'); ?>/construction-type/residential">
                <img src="<?php bloginfo('template_url') ?>/img/icons/home.svg" alt="Multifamily Icon" title="Multifamily Icon"><br/>Multi-family Residential
            </a>
        </p>
    </div>
</section>
